...
export function Select({ children, placeholder, ...props }: ISelectProps) {
  return (
    <SelectPrimitive.Root {...props}>
      ...
      border border-zinc-300 px-3 py-2 shadow-sm data-[placeholder]:text-zinc-600"
      >
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position="popper"
          sideOffset={4}
          className=" z-10 w-[--radix-select-trigger-width] overflow-hidden rounded-lg border border-zinc-200
          bg-white shadow-sm"
        >
